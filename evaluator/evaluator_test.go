...
func TestBangOperator(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if !testBooleanObject(t, evaluated, tt.expected) {
			t.Fatalf("testBooleanObject failed, input: %s\n", tt.input)
		}
	}
}
...
func TestFunctionObject(t *testing.T) {
	...
	if fn.Env == nil {
		t.Fatalf("function has no environment")
	}
	if fn.Body.String() != expectedBody {
		t.Fatalf("body is not %q. got=%q", expectedBody, fn.Body.String())
	}
...
func TestArgumentFunction(t *testing.T) {
	tests := []struct {
		input    string
		expected int64
	}{
		{"let add = fn(x, y) { x + y; }; let apply = fn(a, b, func) {func(a, b);}; apply(1, 2, add);", 3},
		{"let sub = fn(x, y) { x - y; }; let apply = fn(a, b, func) {func(a, b);}; apply(1, 2, sub);", -1},
	}
	for _, tt := range tests {
		testIntegerObject(t, testEval(tt.input), tt.expected)
	}
...
func TestBuiltinFunctions(t *testing.T) {
	...
	for _, tt := range tests {
		...
		case string:
			errOjb, ok := evaluated.(*object.Error)
			if !ok {
...
func TestQuote(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if quote.Node.String() != tt.expected {
			t.Fatalf("quote.Node.String() is not %q. got=%q", tt.expected, quote.Node.String())
		}
	}
}
...
func TestQuoteUnquote(t *testing.T) {
	...
	for _, tt := range tests {
		evaluated := testEval(tt.input)
		quoteTest, ok := evaluated.(*object.Quote)
		if !ok {
			t.Fatalf("object is not Quote. got=%T (%+v)", evaluated, evaluated)
		}
		if quoteTest.Node == nil {
			t.Fatalf("quote.Node is nil")
		}
		if quoteTest.Node.String() != tt.expected {
			t.Fatalf("quote.Node.String() is not %q. got=%q", tt.expected, quoteTest.Node.String())
		}
	}
}
